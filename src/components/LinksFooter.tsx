// Enhanced by AI on 2025-08-15T19:03:29.483Z
// Section: footer
// Category: footer
...
export default function JewelryStoreFooter() {
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Discover a world of handcrafted jewelry that celebrates your unique style. 
                Our collection features one-of-a-kind pieces made with love and attention to detail.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@jewelrystore.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 Jewelry Store. All rights reserved.</span>
